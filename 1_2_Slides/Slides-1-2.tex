...
\hyperlink{Uniform-cdf}{\beamergotobutton{Uniform cdf and r.v. with Uniform distribution}}\\
\hyperlink{Bernoulli-cdf}{\beamergotobutton{Bernoulli cdf and r.v. with Bernoulli distribution}} \\
...
\alert<2>{$$\expec_{f_X}[X] \equiv \int_{-\infty}^{\infty} g(z) f_X(z) dz $$}

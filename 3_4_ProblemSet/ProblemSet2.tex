...
\noindent {\scshape Hint:} There are two ways of doing this problem. One of them is long: use the formula of conditional density and working out through the algebra. There is another shorter approach. Write:
